...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="viewcss/css/bootstrap.min.css">

    <!-- FontAwesome CSS -->
    <link rel="stylesheet" href="viewcss/css/font-awesome.min.css">

    <!-- Swiper CSS -->
    <link rel="stylesheet" href="viewcss/css/swiper.min.css">
